    ...
    def apply_filter(self, filter_function, apply_results=False, parameters=None):
        ...
        if self.__params is not None or parameters is not None:
            if parameters is not None:
                ...
                parameters_list = self.__params.copy()
        ...
        while self.is_running:
            ...
            for frame_num in xrange(30):
                ...
                if return_val:
                    ...
                    directions = self.directions(self.contours, self.target_amount)
                    # FIX
                    # was passing image where it should have been passing the size
