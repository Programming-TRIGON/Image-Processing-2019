...
v = Vision.Vision(camera_port=0, color=ColorToTest, filters=[Filters.area_filter], parameters=[[200]], directions_function=Directions.x_center_directions, target_amount=4,)
